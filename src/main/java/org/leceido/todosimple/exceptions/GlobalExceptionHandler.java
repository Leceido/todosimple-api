...
public class GlobalExceptionHandler extends ResponseEntityExceptionHandler implements AuthenticationFailureHandler {
    ...
    public ResponseEntity<Object> handleDataIntegrityViolationException(
        ...
        logger.error("Failed to save entity with integrity problems: " + errorMessage, dataIntegrityViolationException);
    ...
    public ResponseEntity<Object> handleConstraintViolationException(
        ...
        logger.error("Failed to validate element", constraintViolationException);
        return buildErrorResponse(
    ...
    public ResponseEntity<Object> handleObjectNotFoundException(
        ...
        logger.error("Failed to find the requested element", objectNotFoundException);
    ...
    public ResponseEntity<Object> handleAccessDeniedException(
        ...
        logger.error("Authorization error ", accessDeniedException);
        return buildErrorResponse(
    ...
    public ResponseEntity<Object> handleAuthorizationException(
        ...
        logger.error("Authorization error ", authorizationException);
        return buildErrorResponse(
    ...
    public void onAuthenticationFailure(HttpServletRequest request, HttpServletResponse response, AuthenticationException exception) throws IOException, ServletException {
        ...
        ErrorResponse errorResponse = new ErrorResponse(status, "Usuario ou senha invalidos.");
